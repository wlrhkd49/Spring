...
public class WishListRepositoryTest {
    ...
    public void saveTest() {
        ...
        var extected = wishListRepository.save(wishListEntity);

        Assertions.assertNotNull(extected);
        Assertions.assertEquals(1, extected.getIndex());


    }

    // 새로 업데이트해도 전체 카운트가 증가하지 않고 업데이트되는지 확인
    @Test
